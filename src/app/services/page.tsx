        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={service.id}
              className={cn(
                'group relative rounded-xl overflow-hidden card',
                index === 0 ? 'lg:col-span-2' : '', // Make first item larger
            ...
            >
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-end">
                ...
                <p className="mt-2 text-white/80 leading-relaxed">{service.description}</p>
                 <Button asChild variant="secondary" className="mt-4 w-fit group-hover:bg-primary transition-colors">
                    <Link href="/pricing">
